		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comairbuszdefaultval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comairbuszdefaultval-display": {
								"semanticObject": "comairbuszdefaultval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.airbus.zdefaultval",
									"url": sap.ui.require.toUrl("com/airbus/zdefaultval")
								}
							}
						}
					}
